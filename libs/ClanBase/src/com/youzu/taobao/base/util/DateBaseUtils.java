 ...
 */
public class DateBaseUtils extends com.kit.utils.DateUtils {
    ...
    public static String getDate4Discuz(String unixTimestamp, String format) {
        if (StringUtils.isEmptyOrNullOrNullStr(unixTimestamp)) {
            return "--";
        }
        SimpleDateFormat sd = new SimpleDateFormat(format);

        String date = unixTimestamp;
        try {
            date = sd.format(new Date(Long.parseLong(unixTimestamp + "000")));
        } catch (Exception e) {
