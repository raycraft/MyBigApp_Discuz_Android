package com.youzu.taobao.thread.detail;
...
import com.youzu.taobao.app.config.AppConfig;
import com.youzu.taobao.app.constant.Key;
import com.youzu.taobao.base.callback.FavThreadCallback;
import com.youzu.taobao.base.common.ResultCode;
import com.youzu.taobao.base.enums.MessageVal;
...
import com.youzu.taobao.base.json.threadview.Report;
...
import com.youzu.taobao.base.widget.LoadingDialogFragment;
...
import com.youzu.taobao.thread.ThreadReportActivity;
import com.youzu.taobao.thread.detail.menu.DetailMenuFragment;
import com.youzu.taobao.thread.detail.reply.QuickReplyFragment;
import com.youzu.taobao.threadandarticle.ZhaoHandler;
...
//            webFragment.getWebView().loadUrl("http://192.168.180.23:8080/gaofy/#/posts_detail?bigapp_device=android");
    ...
    private String getFavid() {
        ...
        if (getVariables() != null) {
            ...
            com.youzu.taobao.base.json.favthread.Thread favThread = MyFavUtils.getFavThreadById(this, thread.getTid());
