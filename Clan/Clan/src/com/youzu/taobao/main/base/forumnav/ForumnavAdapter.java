package com.youzu.taobao.main.base.forumnav;
...
public class ForumnavAdapter extends BaseRefreshAdapter<ForumnavJson> {
    ...
    public ForumnavAdapter(Context context, ClanHttpParams params, ForumnavParentAdapter parentAdapter) {
        super(params);
...
//        ZogUtils.printError(ForumnavAdapter.class, "children.size():" + children.size());
    ...
    protected List getData(int page, PagedVariables pagedVariables) {
        ZogUtils.printError(ForumnavAdapter.class, "getThreadDetailData getThreadDetailData getThreadDetailData");
