package com.youzu.taobao.act.manage;
...
import com.youzu.taobao.base.json.ActPlayerJson;
import com.youzu.taobao.base.json.act.ActPlayer;
...
public class AdapterActManage extends BaseRefreshAdapter<ActPlayerJson> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final CheckBox cb_item = com.youzu.taobao.base.widget.ViewHolder.get(convertView, R.id.cb_item);
        TextView tv_name = com.youzu.taobao.base.widget.ViewHolder.get(convertView, R.id.tv_name);
        TextView tv_time = com.youzu.taobao.base.widget.ViewHolder.get(convertView, R.id.tv_time);
        TextView tv_status = com.youzu.taobao.base.widget.ViewHolder.get(convertView, R.id.tv_status);
        TextView tv_desc = com.youzu.taobao.base.widget.ViewHolder.get(convertView, R.id.tv_desc);
        TextView tv_more = com.youzu.taobao.base.widget.ViewHolder.get(convertView, R.id.tv_more);
        View v_margin_bottom = com.youzu.taobao.base.widget.ViewHolder.get(convertView, R.id.v_margin_bottom);
