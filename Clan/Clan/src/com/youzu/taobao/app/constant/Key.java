package com.youzu.taobao.app.constant;

/**
 * Created by Zhao on 15/7/7.
 */
public class Key  extends com.youzu.taobao.base.common.Key{
    ...
    public static final String CLAN_HOME_PAGE_CONFIG = "clan_home_page_config";
    ...
    public static final String KEY_INDEX_PAGE_PIC_MODE = "index_page_pic_mode";


    public static final String KEY_SHOW_GO_TO_TOP = "show_go_to_top";
    ...
    public static final String KEY_HOME_SEND_THREAD = "home_send_thread";
    ...
    public static final String KEY_U_SHOW_DIGETST_IN_TITLE = "user_show_digetst_in_title";
    public static final String KEY_U_SHOW_HOT_IN_TITLE = "user_show_hot_in_title";
    public static final String KEY_U_SHOW_RECOMMEND_IN_TITLE = "user_show_recommend_in_title";
    public static final String KEY_U_DEBUG = "user_debug";
    public static final String KEY_U_SUPER_SETTING = "user_super_setting";
    public static final String KEY_U_MAIN_STYLE = "main_style";
    public static final String KEY_U_THEME_COLOR = "theme_color";
    public static final String KEY_U_SHOW_GROUP_AND_REGISTER_DATE = "show_group_and_register_date";
    public static final String KEY_U_SHOW_BADGE= "user_show_badge";
